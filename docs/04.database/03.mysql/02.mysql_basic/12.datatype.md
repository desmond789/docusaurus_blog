...
* MySQL中的定点数类型只有 DECIMAL 一种类型。
  ...
  ![1705651449506](https://vscode-remote+ssh-002dremote-002b192-002e168-002e123-002e132.vscode-resource.vscode-cdn.net/data/app/gitrepo/docusaurus_blog/docs/database/03.mysql/02.mysql_basic/images/1705651449506.png)
...
* DECIMAL(M,D)的最大取值范围与DOUBLE类型一样
  ...
  * 但是有效的数据范围是由M和D决定的。DECIMAL 的存储空间并不是固定的，由精度值M决定，总共占用的存储空间为M+2个字节。也就是说，在一些对精度要求不高的场景下，比起占用同样字节长度的定点数，浮点数表达的数值范围可以更大一些。
...
![1705651894438](images/1705651894438.png)
...
![1705652029093](images/1705652029093.png)
...
![1705652723936](images/1705652723936.png)

## CHAR与VARCHAR类型

CHAR和VARCHAR类型都可以存储比较短的字符串。

![1705652756903](images/1705652756903.png)
...
![1705652914463](images/1705652914463.png)
...
![1705653092464](images/1705653092464.png)
...
![1705653236681](images/1705653236681.png)
...
![1705653366822](images/1705653366822.png)
...
![1705653517073](images/1705653517073.png)
...
![1705653593883](images/1705653593883.png)
...
![1705653753559](images/1705653753559.png)
