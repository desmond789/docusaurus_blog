...
<img src=".\imgs\image-20221108095747933.png" alt="image-20221108095747933" />

但随着 $n$ 越来越大，比如说 $n=1000$ 时，用二分查找算法（红色）也就是 $54t$，而蓝色算法则需要 $3003t$

<img src=".\imgs\image-20221108100014451.png" alt="image-20221108100014451"  />
...
* 小于等于中间值，都要向左找
* 如果没找到，返回的 i 代表 大于等于 target 的最靠左索引
...
* 大于等于中间值，都要向右找
* 如果没找到，返回的 i 代表 小于等于 target 的最靠右索引
